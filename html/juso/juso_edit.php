...
<?
	$query="select * from juso where no8=$no;";
	...
	$row=mysqli_fetch_array($result);
		...
		$birthday1=substr($row[birthday8],0,4);
		$birthday2=substr($row[birthday8],5,2);
		$birthday3=substr($row[birthday8],8,2);
?>
...
<table width="500" border="1" cellpadding="2" bgcolor="lightyellow" style="border-collapse:collapse">
  <tr>
    ...
    <td width="400" align="left">
      <input type="text" name="name" size="10" value="<?=$row[name8]?>">
    </td>
  </tr>
  <tr>
...
<?
  ...
  <tr>
    ...
    <td width="400" align="left">
      <input type="text" name="juso" size="40" value="<?=$row[juso8]?>">
    </td>
  </tr>
</table>
<br>
