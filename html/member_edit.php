							...
							<tr>
								<td align="center">
									<table border="0" cellpadding="0" cellspacing="0" width="635" class="cmfont">
										...
										<tr>
											<td width="127" height="30">
												<img align="absmiddle" name="pwd" src="images/i_dot.gif" border="0"><font color="898989"><b>비밀번호</b></font>
											</td>
											<td><?=$row[pwd8]?></td>
										</tr>
										<tr>
									...
									<table border="0" cellpadding="0" cellspacing="0" width="635" class="cmfont">
										<tr>
											...
											<td>
												<input type="text" name="name" maxlength="10" value="<?=$row[name8]?>" size="20" class="cmfont1">
											</td>
										</tr>
										<tr>
											<td width="127" height="30">
									...
									<table border="0" cellpadding="0" cellspacing="0" width="635" class="cmfont">
										...
										<tr>
											...
											<td>
												<input type="text" name='zip' size = "5" maxlength = "5" value = "<?=$row[zip8]?>" class="cmfont1">
												<a href="javascript:FindZip(0)"><img align="absmiddle" src="images/b_zip.gif" border="0"></a><br>
												<input type="text" name='juso' size = "50" maxlength = "200" value = "<?=$row[juso8]?>" class="cmfont1"><br>
											</td>
										</tr>
										<tr>
											<td width="127" height="50">
											...
											<td>
												<input type="text" name='email' size="50" maxlength="50" value="<?=$row[email8]?>" class="cmfont1">
											</td>
										</tr>
										<tr><td colspan="2" height="10"></td></tr>
										<tr><td colspan="2" bgcolor="E6DDD5"></td></tr>
