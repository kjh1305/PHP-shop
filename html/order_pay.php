...
<?
	...
	$o_tel=sprintf("%02d%04d%04d",$o_tel1,$o_tel2,$o_tel3);
	$o_phone1 = $_REQUEST[o_phone1];
	$o_phone2 = $_REQUEST[o_phone2];
	$o_phone3 = $_REQUEST[o_phone3];
	$o_phone=sprintf("%03d%04d%04d",$o_phone1,$o_phone2,$o_phone3);
	...
	$r_tel=sprintf("%02d%04d%04d",$r_tel1,$r_tel2,$r_tel3);
	$r_phone1 = $_REQUEST[r_phone1];
	$r_phone2 = $_REQUEST[r_phone2];
	$r_phone3 = $_REQUEST[r_phone3];
	$r_phone=sprintf("%03d%04d%04d",$r_phone1,$r_phone2,$r_phone3);
