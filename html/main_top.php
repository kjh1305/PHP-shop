...
<table width="959" height="25" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<tr bgcolor="#F0F0F0">
		...
		<td width="135">
			<input type="text" name="findtext" maxlength="40" size="17" value="<?=$findtext1?>" class="cmfont1">
		</td>
		</form>
		<!-- form1 끝 -->
					...
					<td valign="top"> 
						...
						<table width="177"  border="0" cellpadding="2" cellspacing="1" bgcolor="#afafaf">
							...
							echo("<tr>
								<td bgcolor='#FFFFFF'>
									<table width='100%'  border='0' cellspacing='0' cellpadding='0'>
									<tr><td height='30' bgcolor'#f0f0f0' align='center' style='font-size:12pt;color:#333333'><a href='product.html?menu=$i'<b>$a_menu[$i]</b></a></td></tr>
									</table>
								</td>
							</tr>");}
							*/
