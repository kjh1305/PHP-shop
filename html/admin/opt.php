...
<table width="500" border="1" cellpadding="2"  style="border-collapse:collapse">
	<tr bgcolor="#CCCCCC" height="20"> 
		<td width="50"  align="center"><font color="#142712"></font></td>
	...
	for($i=0; $i<$page_last; $i++)
		{
			$row=mysqli_fetch_array($result);
				...
				echo("<tr bgcolor='#F2F2F2' height='20'>	
					<td width='50'  align='center'>$row[no8]</td>
					<td width='250' align='left'>$row[name8]</td>
					<td width='100' align='center'>
						<a href='opt_edit.php?no1=$row[no8]'>수정</a>/
						<a href='opt_delete.php?no1=$row[no8]' onclick='javascript:return confirm('삭제할까요 ?');'>삭제</a>
					</td>
					<td width='100' align='center'><a href='opts.php?no1=$row[no8]'>소옵션편집</a></td>
				</tr>");
		}
?>
</table>
...
echo("<table width='400' border='0' cellspacing='0' cellpadding='0'>
	...
	{
		$tmp=$page_s;
		echo("<a href='opt.php?page=$tmp=$no1'>
	...
	for($i=$page_s+1; $i<=$page_e; $i++)
	{
		if($page==$i)
			...
			echo("&nbsp;<a href='opt.php?page=$i=$no1'>[$i]</a>&nbsp;");
	}
	if($block < $blocks)
	{
		$tmp=$page_e+1;
